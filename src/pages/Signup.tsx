    ...
    <div className="h-screen w-screen bg-gray-200 flex justify-center items-center">
      <div className="bg-white rounded-md border min-w-72 p-16">
        ...
        <div className="flex justify-center pt-4s">
          <button
            onClick={signup}
            className="bg-purple-600 hover:bg-purple-300 hover:text-purple-500 text-white w-full py-1 px-4 text-md rounded-md p-4 m-1.5 items-center justify-center"
          >
            Signup
          </button>
        </div>
